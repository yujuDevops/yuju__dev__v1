...
export const BannerVida = () => {
  return (
    ...
    <h2 className="h2Banner">Vos elegís cómo cuidar tu salud. <span className="spanBanner">Yuju te asesora para que elijas el mejor seguro.<br/> Tenemos varias opciones de aseguradoras.</span>   <br/>¿Querés saber más?<br/>
    <br/>

...
export const HeaderRetiro = () => {
  return (
    ...
    <h1 className='h1-motos'>SEGURO DE RETIRO</h1>
    <h2 className='h2-motos'>Invertí en tu futuro. El producto ideal para complementar tu jubilación.</h2>
    <h3 className='h3-motos'></h3>

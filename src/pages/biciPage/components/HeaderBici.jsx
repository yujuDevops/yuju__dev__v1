...
export const HeaderBici = () => {
  return (
   ...
   <img  src="https://res.cloudinary.com/dewcgbpvp/image/upload/v1730319646/Mobile-bicicleta_jwgwvq.jpg" alt="" className='imgFotoCelular'  />
   ...
   <h3 className='h3-bici'>Te ofrecemos un seguro ágil que cuida de vos y tu bici.<br/> Elegí tu cobertura y sumá kilómetros sin preocupaciones.</h3>
    <button className='buttonBiciHeader'><a href="">Cotizá</a></button>
   </div>
